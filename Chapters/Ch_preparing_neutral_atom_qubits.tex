...
The communication qubit state must be initialized for attempting
atom-photon entanglement generation.

\subsection{Optical pumping and microwave rotations}
D1 line pumping, D2 line repump. can have schematic of the pumping
levels here. 

pumping verified with microwave rotations
